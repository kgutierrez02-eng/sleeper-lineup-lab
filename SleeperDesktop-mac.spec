...
# macOS build: produces a double-clickable "Sleeper Lineup Lab.app" bundle.
# Shares the same app modules/entry point as the Windows spec.
...
app = BUNDLE(coll, name="Sleeper Lineup Lab.app", icon=None,
             bundle_identifier="com.kgutierrez.sleeperlineuplab",
